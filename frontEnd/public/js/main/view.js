...
const chatBotQuestionView = () => {
    ...
    $questionContainer.appendChild(chatBotQuestionView01());
    $questionContainer.appendChild(chatBotQuestionView02());
    $questionContainer.appendChild(chatBotQuestionView03());
...
export { 
    ...
    chatBotManagerView, 
    chatBotQuestionView01, chatBotQuestionView02, chatBotQuestionView03, chatBotQuestionView,
